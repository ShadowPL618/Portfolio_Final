...
/**
 * pages/ebsy.php
 * Embedded Systems Projects detail page.
 * Shows carousel of images/videos, description, and GitHub link per project.
 */
require_once '../includes/db_connection.php';
require_once '../includes/functions.php';

$page_title = 'EBSY – Embedded Systems Projects';
$projects   = getProjectsByCategory('EBSY');
?>
<?php include '../includes/header.php'; ?>

<section class="section proj-section--ebsy">
    <div class="section-container">

        <div class="proj-section-header">
            <div class="proj-section-icon"><i class="fas fa-microchip"></i></div>
            <div>
                <h2 class="section-title">EBSY</h2>
                <p class="section-subtitle">Embedded Systems Projects</p>
            </div>
        </div>
