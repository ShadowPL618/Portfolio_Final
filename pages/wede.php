...
/**
 * pages/wede.php
 * Web Development Projects detail page.
 * Shows carousel of images/videos, description, and GitHub link per project.
 */
require_once '../includes/db_connection.php';
require_once '../includes/functions.php';

$page_title = 'WEDE – Web Development Projects';
$projects   = getProjectsByCategory('WEDE');
?>
<?php include '../includes/header.php'; ?>

<section class="section proj-section--wede">
    <div class="section-container">

        <div class="proj-section-header">
            <div class="proj-section-icon"><i class="fas fa-globe"></i></div>
            <div>
                <h2 class="section-title">WEDE</h2>
                <p class="section-subtitle">Web Development Projects</p>
            </div>
        </div>
